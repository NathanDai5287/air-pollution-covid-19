...
#     # meteorological.set_index('date_local', inplace=True)
#     # pollution.set_index('date_local', inplace=True)

#     temp = pollution.merge(meteorological, how='outer', on='date_local')
#     del temp['Unnamed: 0']
...
if __name__ == "__main__":
    pollution_paths = [path for path in glob.glob('Data Collection\Data\Air Pollution\*.csv')]
    meteorological_paths = [path for path in glob.glob('Data Collection\Data\Meteorological\*.csv')]
